...
public class QueryFieldUtil {
    ...
    protected static <T extends Comparable<? super T>, E, A1, A2> Specification<E> createRange(
        ...
        if (spec == null) {
            ...
            else if (filter.getGte() != null) spec.and(GreaterThanSpec.spec(filter.getGt(), true, attr1, attr2, valAttr));
    ...
    protected static <T extends Comparable<? super T>, E, A1, A2, A3> Specification<E> createRange(
        ...
        if (spec == null) {
            ...
            if (filter.getGt() != null) spec.and(GreaterThanSpec.spec(filter.getGt(), false, attr1, attr2, attr3, valAttr));
            else if (filter.getGte() != null) spec.and(GreaterThanSpec.spec(filter.getGt(), true, attr1, attr2, attr3, valAttr));

            if (filter.getLt() != null) spec.and(LessThanSpec.spec(filter.getLt(), false, attr1, attr2, attr3, valAttr));
            else if (filter.getLte() != null) spec.and(LessThanSpec.spec(filter.getLte(), true, attr1, attr2, attr3, valAttr));
        }
        return spec;
    }
