...
public class UserListener {
    ...
    public SendMessage register(@UserId long telegramId, Message message) {
        if (!authService.isUserRegistered(telegramId)) {
            ...
            if (userApprovalService.existsByTelegramId(telegramId)) {
                ...
                return NotifierService.WAITING_APPROVAL(telegramId, approval);
            }
            ...
            return SendMessage.builder()
                    ...
                    .replyMarkup(InlineKeyboardMarkup.builder()
                            .keyboardRow(NotifierService.UNREGISTERED_USER)
                            .build())
                    .build();
        }
    ...
    public SendMessage setting(@TgAuth dev.scaraz.mars.v1.core.domain.credential.User user,
                               @Text String text
    ) {
