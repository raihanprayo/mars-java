package dev.scaraz.mars.app.telegram.domain;
...
@AllArgsConstructor
@RedisHash("tg:update")
public class UpdateCache implements BotApiObject, Serializable {
    ...
    public static UpdateCache fromUpdate(Update a) {
        return builder()
                .updateId(a.getUpdateId())
                .message(a.getMessage())
                .inlineQuery(a.getInlineQuery())
                .chosenInlineQuery(a.getChosenInlineQuery())
                .callbackQuery(a.getCallbackQuery())
                .editedMessage(a.getEditedMessage())
                .channelPost(a.getChannelPost())
                .editedChannelPost(a.getChannelPost())
                .shippingQuery(a.getShippingQuery())
                .preCheckoutQuery(a.getPreCheckoutQuery())
                .poll(a.getPoll())
                .pollAnswer(a.getPollAnswer())
                .myChatMember(a.getMyChatMember())
                .chatMember(a.getChatMember())
                .chatJoinRequest(a.getChatJoinRequest())
                .build();
